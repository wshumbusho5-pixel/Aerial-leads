...
# Project Paths
# ========================================
# settings.py is in shared/config/, so go up 3 levels to get project root
BASE_DIR = Path(__file__).resolve().parent.parent.parent
CONFIG_DIR = BASE_DIR / 'shared' / 'config'
DATA_DIR = BASE_DIR / 'data'

# Sellers data (leads)
SELLERS_DATA_DIR = DATA_DIR / 'sellers'
RAW_DATA_DIR = SELLERS_DATA_DIR / 'raw'
PROCESSED_DATA_DIR = SELLERS_DATA_DIR / 'processed'
DNC_DATA_DIR = SELLERS_DATA_DIR / 'dnc'

# Buyers data (investors)
BUYERS_DATA_DIR = DATA_DIR / 'buyers'
BUYERS_RAW_DIR = BUYERS_DATA_DIR / 'raw'
BUYERS_PROCESSED_DIR = BUYERS_DATA_DIR / 'processed'

# Deals data
DEALS_DATA_DIR = DATA_DIR / 'deals'
...
for directory in [DATA_DIR, RAW_DATA_DIR, PROCESSED_DATA_DIR, DNC_DATA_DIR,
                  BUYERS_RAW_DIR, BUYERS_PROCESSED_DIR, DEALS_DATA_DIR,
